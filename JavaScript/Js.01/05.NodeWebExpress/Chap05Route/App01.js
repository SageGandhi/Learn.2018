...
app.set('view engine', 'ejs');// View Engine Will Be Pug,Use npm install ejs --save
// Start Operation
app.get('/', (req, res) => {
  // Used For Pug Based Render Will Be Found In ./src/views/index.pug
  res.render('index', {
    Label: 'Book Library',
    Owners: ['Prajit Gandhi', 'Swagat Srichandan', 'Debashis  Baskey', 'Sraboni Ghorai']
  });
});
app.get('/storystrap', (req, res) => {
  // Used For Pug Based Render Will Be Found In ./src/views/index.pug
  res.render('storystrap', {
