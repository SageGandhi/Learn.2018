package edu.gandhi.prajit.maven.chap01;
...
@ContextConfiguration("/Chap01/Beans.xml")
public class SystemConfigurationMethodsTestXml {
	// Use Spring Explorer Perspective
	@Autowired
